    ...
    >
        <View style={[gStyle.container,{backgroundColor:'#f6f7f7'}]}>
            ...
            <View style={[gStyle.flexRowSpace,{
                        ...
                        <Text>{props.t('screen.module.pickup.detail.text_confirm_stock_btn')}</Text>
                        <TouchableOpacity 
            ...
            <View>
                <TextInputComponent
                    ...
                    textLabel = {props.t('screen.module.pickup.detail.exception_input_text')}
                    inputValue = {'0'}
            ...
            <View style={[gStyle.flexRowCenter,{marginTop:20}]}>
                <TouchableOpacity style={[styles.bottomButton,
                    ...
                    {props.t('screen.module.pickup.detail.exception_btn_out')}
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.bottomButton,
                    ...
                    <Text style={[styles.textButton]}>
                    {props.t('screen.module.pickup.detail.exception_btn_over')}
                    </Text>
                </TouchableOpacity>
            </View>
        </View>
