...
const CircularProgress = ({
  ...
  const ringColorStyle = {
    borderRightColor: percent > 98 ? colors.brandPrimary : colors.boxmeBrand ,
    borderTopColor: percent > 98 ? colors.brandPrimary : colors.boxmeBrand,
  };
  ...
  return (
    <View style={[styles.container, { width: radius * 2, height: radius * 2 }]}>
      ...
      <Text style={{...gStyle.textBoxmeBold20,color:colors.brandPrimary}}>{percent}%</Text>
    </View>
  );
};
