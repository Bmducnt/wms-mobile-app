  ...
  render() {
    ...
    return (
      <View style={[gStyle.container]}>
        <View >
          <ScreenHeader
            title={t('screen.module.taks.header_text')}
            showBack={false}
            isFull={true}
            showInput={false}
            inputValueSend={null}
              ...
              backgroundColor:colors.transparent
                ...
                <View style={[gStyle.flexCenter,{paddingHorizontal:10}]}>
                    ...
                    <Text style={{...gStyle.textBoxme12,color:colors.greyInactive}}>
                      {t('screen.module.taks.status_await')}
                    </Text>
                </View>
                ...
                <View style={{marginLeft:5}}>
                    <View style={[gStyle.flexRow,{marginTop:5,marginLeft:10}]}>
                      ...
                      <Text style={{paddingTop:5,color:colors.greyInactive,paddingLeft:5,}}>+{list_staff.length - 5} {t('screen.module.taks.unit_staff')}</Text>
                    </View>
                </View>
            </View>
            <View style={[gStyle.flexRow,{
              ...
              marginTop:5
                ...
                <TaskScrollList onSelect = {this.fetchListTasks} t={t} />
            </View>
